...
public class AuthFilter_Permission implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AuthFilter_Market:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AuthFilter_Market:DoAfterProcessing");
        }
    ...
    // <editor-fold defaultstate="collapsed" desc="Encapsulate methods.">
    /**
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("AuthFilter_Market:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AuthFilter_Market()");
        }
        StringBuffer sb = new StringBuffer("AuthFilter_Market(");
